...
export const PUBLISHER_OPTIONS = 'PUBLISHER_OPTIONS';
export const UPDATE_PUBLISHER = 'UPDATE_PUBLISHER';
export const UNIVERSITY_PUBLISHER = 'UNIVERSITY_PUBLISHER';
...
export const IDR_LIST = 'IDR_LIST';
...
export const FETCH_ALL_MESSAGES_LIST = 'FETCH_ALL_MESSAGES_LIST';
export const FETCH_TEMPLATE = 'FETCH_TEMPLATE';
export const FETCH_TEMPLATES_LIST = 'FETCH_TEMPLATES_LIST';
export const FETCH_ALL_TEMPLATES_LIST = 'FETCH_ALL_TEMPLATES_LIST';
...
export const USERS_REQUESTS_UPDATE = 'USERS_REQUESTS_UPDATE';
